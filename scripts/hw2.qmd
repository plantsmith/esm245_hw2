...
```
```{r}
ggplot(log_anchovy_data, aes(x = year, y = log_landing, color = zone)) +
  geom_line() 
```
...
-   The coefficient for 'north' of 0.311 indicates that log of landings in the North Central zone were higher than the South zone.
